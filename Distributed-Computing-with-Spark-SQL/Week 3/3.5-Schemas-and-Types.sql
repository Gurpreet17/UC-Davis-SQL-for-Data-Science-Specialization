...
-- MAGIC
-- MAGIC The Spark [`types` package](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql.html#data-types) provides the building blocks for constructing schemas.
-- MAGIC
